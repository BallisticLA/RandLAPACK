    ...
    for(iter = 0; iter < maxiter; ++iter) {
        ...
        if((curr_sz >= n) || (block_rank != b_sz_const)) {
            ...
            if(this -> timing) {
                ...
                std::cout << "QRCP_wide main time:                  " << qrcp_main_t_dur << " μs,\n";
                std::cout << "Copy(A_sk) time:                      " << copy_A_sk_t_dur << " μs,\n";
                std::cout << "QRCP_wide piv time:                   " << qrcp_piv_t_dur << " μs,\n";
                std::cout << "Copy(A) time:                         " << copy_A_t_dur << " μs,\n";
                std::cout << "Piv(A) time:                          " << piv_A_t_dur << " μs,\n";
                std::cout << "Copy(J) time:                         " << copy_J_t_dur << " μs,\n";
                std::cout << "J updating time:                      " << updating_J_t_dur << " μs,\n";
                std::cout << "Preconditioning time:                 " << preconditioning_t_dur << " μs,\n";
                std::cout << "QR_tall time:                         " << qr_tall_t_dur << " μs,\n";
                std::cout << "Householder reconstruction time:      " << q_reconstruction_t_dur << " μs,\n";
                std::cout << "Apply QT time:                        " << apply_transq_t_dur << " μs,\n";
                std::cout << "Sample updating time:                 " << sample_update_t_dur << " μs,\n";
                std::cout << "Other routines time:                  " << t_rest << " μs,\n";
                std::cout << "Total time:                           " << total_t_dur << " μs.\n";

                std::cout << "\nPreallocation takes                 " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) preallocation_t_dur    / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "QRCP_wide main takes                  " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) qrcp_main_t_dur        / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Copy(A_sk) takes                      " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) copy_A_sk_t_dur        / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "QRCP_wide piv takes                   " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) qrcp_piv_t_dur         / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Copy(A) takes                         " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) copy_A_t_dur           / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Piv(A) takes                          " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) piv_A_t_dur            / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Copy(J) takes                         " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) copy_J_t_dur           / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "J updating time takes                 " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) updating_J_t_dur       / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Preconditioning takes                 " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) preconditioning_t_dur  / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "QR_tall takes                         " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) qr_tall_t_dur          / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Householder reconstruction takes      " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) q_reconstruction_t_dur / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Apply QT takes                        " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) apply_transq_t_dur     / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Sample updating time takes            " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) sample_update_t_dur    / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Everything else takes                 " << std::fixed << std::setprecision(2) << std::setw(6) << 100 * ((T) t_rest                 / (T) total_t_dur) << "% of runtime.\n";
