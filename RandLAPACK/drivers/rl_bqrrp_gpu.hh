    ...
    for(iter = 0; iter < maxiter; ++iter) {
        ...
        if((curr_sz >= std::min(m, n)) || (block_rank != b_sz_const)) {
            ...
            if(this -> timing) {
                ...
                std::cout << "\nPreallocation takes                 " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) preallocation_t_dur    / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "QRCP_wide main takes                  " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) qrcp_main_t_dur        / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Copy(A_sk) takes                      " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) copy_A_sk_t_dur        / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "QRCP_wide piv takes                   " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) qrcp_piv_t_dur         / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Copy(A) takes                         " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) copy_A_t_dur           / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Piv(A) takes                          " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) piv_A_t_dur            / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Copy(J) takes                         " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) copy_J_t_dur           / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "J updating time takes                 " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) updating_J_t_dur       / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Preconditioning takes                 " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) preconditioning_t_dur  / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "QR_tall takes                         " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) qr_tall_t_dur          / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Householder reconstruction takes      " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) q_reconstruction_t_dur / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Apply QT takes                        " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) apply_transq_t_dur     / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Sample updating time takes            " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) sample_update_t_dur    / (T) total_t_dur) << "% of runtime.\n";
                std::cout << "Everything else takes                 " << std::fixed << std::setw(6) << std::setprecision(2) << 100 * ((T) t_rest                 / (T) total_t_dur) << "% of runtime.\n";
