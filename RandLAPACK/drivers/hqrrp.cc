...
/* ========================================================================= */
template <typename T>
int64_t NoFLA_Normal_random_matrix( int64_t m_A, int64_t n_A, 
...
// ============================================================================
template <typename T>
int64_t NoFLA_QRPmod_WY_unb_var4( int64_t pivoting, int64_t num_stages, 
               int64_t m_A, int64_t n_A, T * buff_A, int64_t ldim_A,
...
template int64_t hqrrp<double>( int64_t m_A, int64_t n_A, double * buff_A, int64_t ldim_A,
        int64_t * buff_jpvt, double * buff_tau,
        int64_t nb_alg, int64_t pp, int64_t panel_pivoting );

template int64_t hqrrp<float>( int64_t m_A, int64_t n_A, float * buff_A, int64_t ldim_A,
