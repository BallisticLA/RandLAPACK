...
int CholQRCP<T>::CholQRCP1(
    ...
    */
    ...
    if(this -> timing)
    {
        ...
        printf("Copying time: %d μs,\n", copy_t_dur);
        printf("Resizing time: %d μs,\n", resize_t_dur);
...
/*
// THIS VERSION OF THE CODE PRESERVES MATRIX A
...
int CholQRCP<T>::CholQRCP1(
    ...
    RandBLAS::sasos::sketch_csccol(sas, n, (double*) Q_dat, (double*) A_hat_dat, this->num_threads);
