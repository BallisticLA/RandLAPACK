...
process_dat() {
    ...
    std::string path_in = "../../testing/RandLAPACK-Testing/test_benchmark/QR/speed/raw_data/old_hqrrp/BEST_CASE_";
    std::string path_out = "../../testing/RandLAPACK-Testing/test_benchmark/QR/flops/raw_data/old_hqrrp/BEST_CASE_";
