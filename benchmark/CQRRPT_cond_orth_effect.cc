...
int main(){
    ...
    */
    ...
    test_cond_orth<double>(10e6, 700, 700, 2 * 700, 4, 10e7, 10e7, 10, state, 0, 1, 1, 9);
    test_cond_orth<double>(10e6, 700, 700, 2 * 700, 4, 10e9, 10e9, 10, state, 0, 1, 1, 9);
    test_cond_orth<double>(10e6, 700, 700, 2 * 700, 4, 10e11, 10e11, 10, state, 0, 1, 1, 9);
    test_cond_orth<double>(10e6, 700, 700, 2 * 700, 4, 10e13, 10e13, 10, state, 0, 1, 1, 9);
    test_cond_orth<double>(10e6, 700, 700, 2 * 700, 4, 10e15, 10e15, 10, state, 0, 1, 1, 9);
