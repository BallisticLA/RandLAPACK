...
int main(){
    ...
    */
    ...
    test_cond_orth<double>(10e6, 500, 500, 2 * 500, 4, 10e7, 10e15, 10, state, 0, 1, 1, 9);
    test_cond_orth<double>(10e6, 500, 500, 2 * 500, 4, 10e9, 10e17, 10, state, 0, 1, 1, 9);
    test_cond_orth<double>(10e6, 500, 500, 2 * 500, 4, 10e11, 10e18, 10, state, 0, 1, 1, 9);
    test_cond_orth<double>(10e6, 500, 500, 2 * 500, 4, 10e13, 10e19, 10, state, 0, 1, 1, 9);
    test_cond_orth<double>(10e6, 500, 500, 2 * 500, 4, 10e15, 10e20, 10, state, 0, 1, 1, 9);
