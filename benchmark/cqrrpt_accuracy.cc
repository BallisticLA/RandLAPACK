...
template <typename T>
    static void test_cqrrpt1_approx_qual(int64_t m, int64_t n, int64_t k, int64_t d, int64_t nnz, T tol, const std::tuple<int, T, bool>& mat_type, uint32_t seed, int test_num, std::string path) {
...
int main() {
    ...
    test_cqrrpt1_approx_qual<double>(131072, 2000, 2000, 10000, 4, std::pow(std::numeric_limits<double>::epsilon(), 0.5265), std::make_tuple(0, 1e10, false), 1, 1, "../testing/RandLAPACK-Testing/test_benchmark/QR/accuracy/raw_data/");
    return 0;
}
