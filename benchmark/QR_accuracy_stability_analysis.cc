...
int main(){
    ...
    */
    ...
    test_cond_orth<double>(10e6, 300, 10e7, 10e7, 100, state, 1, 9, {300, 20 * 300, 20, 4, 1, 0, 1});
    test_cond_orth<double>(10e6, 300, 10e7, 10e7, 100, state, 1, 9, {300, 20 * 300, 20, 4, 1, 0, 0});
    test_cond_orth<double>(10e6, 300, 10e7, 10e7, 100, state, 1, 9, {300, 20 * 300, 20, 4, 1, 1});
