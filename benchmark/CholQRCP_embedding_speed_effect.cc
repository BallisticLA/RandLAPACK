...
test_speed(int r_pow, 
    ...
    for (; d_multiplier <= d_multiplier_max; ++d_multiplier) {
        std::vector<long> res;
...
int main(){
    ...
    test_speed<double>(17, 2048, 5, 1, 36, std::pow(std::numeric_limits<double>::epsilon(), 0.75), 1.0, 1.0, 5.0, std::make_tuple(6, 0, false));
