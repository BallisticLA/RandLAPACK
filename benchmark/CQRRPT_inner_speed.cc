...
int main(){
    ...
    test_speed<double>(17, 17, 32, 16384, 5, 1, 36, std::pow(std::numeric_limits<double>::epsilon(), 0.75), 1.0, 1.0, std::make_tuple(6, 0, false), "../../testing/RandLAPACK-Testing/test_benchmark/QR/speed/raw_data/cqrrpt_determine_rank/L2", state);
    return 0;
}
