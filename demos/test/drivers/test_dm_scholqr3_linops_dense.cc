// Test suite for sCholQR3_linops driver with linear operators (dense matrices)
...
TEST_F(TestDmSCholQR3Linops, composite_operator) {
    int64_t n_spd = 50;
...
TEST_F(TestDmSCholQR3Linops, nested_composite_operator) {
    int64_t m = 100;
    int64_t k_dim = 50;
    int64_t n = 20;
    double tol = std::pow(std::numeric_limits<double>::epsilon(), 0.85);
...
// Test with nested composite operator: CholSolver * (SASO * Gaussian) (large scale)
TEST_F(TestDmSCholQR3Linops, nested_composite_operator_large_square) {
    int64_t m = 1138;
    int64_t k_dim = 1138;
    int64_t n = 100;
    double tol = std::pow(std::numeric_limits<double>::epsilon(), 0.85);
