// Shared utilities for RandLAPACK demo tests
// Common helper functions used across multiple demo test files

#ifndef RANDLAPACK_DEMOS_TEST_UTILS_HH
#define RANDLAPACK_DEMOS_TEST_UTILS_HH
