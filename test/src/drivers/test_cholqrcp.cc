...
{ 
    for (uint32_t seed : {2})//, 1, 2})
    {
        ...
        test_CholQRCP1_bench_qual<double>(131072, 2000, 2000, 2000, 2, std::pow(1.0e-16, 0.75), std::make_tuple(0, 2, false), seed);
        test_CholQRCP1_bench_qual<double>(131072, 2000, 2000, 4000, 2, std::pow(1.0e-16, 0.75), std::make_tuple(0, 2, false), seed);
        test_CholQRCP1_bench_qual<double>(131072, 2000, 2000, 6000, 2, std::pow(1.0e-16, 0.75), std::make_tuple(0, 2, false), seed);
    }
}
