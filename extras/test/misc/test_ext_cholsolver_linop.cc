...
protected:
    ...
    void test_cholsolver_half_solve(
        ...
        T cond_num = 10.0;
        RandLAPACK_extras::generate_spd_matrix_file<T>(spd_filename, spd_dim, cond_num, state);
        ...
        RandLAPACK_extras::CholSolverLinOp<T> L_inv_op(spd_filename, /*half_solve=*/true);
    ...
    void test_cholsolver_linop(
        ...
        RandLAPACK_extras::CholSolverLinOp<T> A_inv_op(spd_filename);
